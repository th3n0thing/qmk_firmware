...
bool process_record_user(uint16_t keycode, keyrecord_t *record)
{
  switch (keycode)
  {
	...
	case RUN_ECL:
      if (record->event.pressed)
      {
        SEND_STRING(SS_DOWN(X_LCTL) SS_TAP(X_F11) SS_UP(X_LCTL));
      } 
      break;
	...
	case LCK_WIN:
      if (record->event.pressed)
      {
        SEND_STRING(SS_DOWN(X_RGUI) SS_TAP(X_L) SS_UP(X_RGUI));
      } 
      break;	 
  }
  return true;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    MO(3),   KC_HOME, KC_END,  KC_NO,   KC_NO,   KC_PSCR, KC_INS,  KC_NO,   KC_NO,   KC_VOLD, KC_VOLU, KC_NO,   DM_PLY1, DM_PLY2,
    KC_TRNS, DSK_LFT, DSK_RGT, RUN_ECL, CTALDEL, KC_NO,   KC_NO,   KC_HOME, KC_END,  SLC_R2L, SLC_L2R, KC_NO,            LCK_WIN,   
	...
	DM_RSTP, KC_NO,   KC_PSLS, KC_PAST, KC_PMNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   RGB_TOG, KC_NO,   KC_BSPC,
    KC_BSPC, KC_P7,   KC_P8,   KC_P9,   KC_PPLS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   DM_REC1, DM_REC2,
    KC_NO,   KC_P4,   KC_P5,   KC_P6,   KC_PENT, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,  
    KC_NO,            KC_P1,   KC_P2,   KC_P3,   KC_PENT, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_UP,   
    KC_NO,   KC_LGUI, KC_PDOT,                            KC_P0,                              KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT),
	
    [3] = LAYOUT_60_ansi(
	
	KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    KC_TRNS, KC_PGUP, KC_PGDN, KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    KC_TRNS, KC_PGUP, KC_PGDN, KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,  
